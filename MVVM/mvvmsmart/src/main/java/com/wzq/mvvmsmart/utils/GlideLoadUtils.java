...
public class GlideLoadUtils {
                        ...
                        protected void setResource(Bitmap resource) {
                            ...
                            RoundedBitmapDrawable roundedBitmapDrawable =
                                    RoundedBitmapDrawableFactory.
                                            create(target.getContext().getResources()
                                                    , resource);
     ...
     * @param url  资源路径
     */
    public static void loadCircleImg(Context context,
                                     int placeHolderID,
     ...
     * 圆形图片外边带一个圈, 经常用于加载头像
     */
    public static void loadCircleImgBorder(Context context,
                                           int placeHolderID,
                                           ImageView target,
                                           String url) {
        try {
            ...
            Glide.with(context)
                    ...
                    .circleCrop()
                    .placeholder(placeHolderID)
                    .transform(new GlideCircleTransformWithBorder
                            (context, 2,
...
//                    .diskCacheStrategy(DiskCacheStrategy.ALL)
     ...
     * @param bitmap
     */
    public static void loadRoundImgWithBitmap(final Context context,
                                              int placeHolderID,
                                              final ImageView target, Bitmap bitmap) {
        try {
